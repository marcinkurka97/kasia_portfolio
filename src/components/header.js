      ...
      <div>
        <header id="header" ref="sideMenu">
          ...
          <div className="header-title">
            <p>Hi! I'm Kasia and this is my portfolio.</p>
          </div>
          <div className={this.state.menuIsOpen ? "header-links-opened" : "header-links"}>
            <Link to="/" style={style} activeStyle={activeStyle}>
              Illustrations
            </Link>
            <Link to="/school" style={style} activeStyle={activeStyle}>
              School
            </Link>
            <Link to="/threeD" style={style} activeStyle={activeStyle}>
              3d
            </Link>
          </div>
          <div className={this.state.menuIsOpen ? "header-svgs-opened" : "header-svgs"}>
